...
function PastEvent() {
  ...
  const confirmAllAttendees = async () => {
    ...
    try {
      ...
      if (rsvpContract) {
        ...
        const txn = await rsvpContract.confrimAllAttendees(event.id, {
          gasLimit: 300000,
        });
  ...
  function checkIfConfirmed (event, address) {
    for (let i = 0; i < event.confirmAttendees.length; i++) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap py-8">
          ...
          <div className="sm:w-10/12 sm:pl-8">
            ...
            {account
              ? (
                account.address.toLocaleLowerCase() === event.eventOwner.toLocaleLowerCase()
                  ? (
                    <section>
                      ...
                      <div className="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
                        <div className="inline-block min-w-full py-w align-middle md:px-6 lg:px-8">
