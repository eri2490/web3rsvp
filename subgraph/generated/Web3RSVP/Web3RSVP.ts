...
export class NesRSVP extends ethereum.Event {
  get params(): NesRSVP__Params {
    return new NesRSVP__Params(this);
  }
}

export class NesRSVP__Params {
  _event: NesRSVP;

  constructor(event: NesRSVP) {
    this._event = event;
  }
